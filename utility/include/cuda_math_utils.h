...
/**
 * Edited and adapted to RTCV needs by Matthias Michael
 * 
...
#ifndef __CUDACC__ // CUDAs math.h provides a fminf implementation, C++ not
...
#ifndef __CUDACC__ // CUDAs math.h provides a min implementation, C++ not
...
#ifndef __CUDACC__ // CUDAs math.h provides a fmaxf implementation, C++ not
...
#ifndef __CUDACC__ // CUDAs math.h provides a max implementation, C++ not
...
#ifndef __CUDACC__ // CUDAs math.h provides a max implementation, C++ not
inline __host__ __device__ uint max(uint a, uint b)
{
	return a > b ? a : b;
}
#endif
...
#ifndef __CUDACC__ // rsqrtf is not defined in C++ math.h
inline float rsqrtf(float x)
{
	return 1.f/sqrtf(x); // maybe not speed-optimal but better than nothing
}
#endif
...
inline __host__ __device__ float norm(float2 v)
{
	return sqrtf(dot(v, v));
}
...
//////////////////////////////////////////////////////////////////////////
// Conversion to lower dimensions
//////////////////////////////////////////////////////////////////////////

inline __device__ __host__ float3 top3(float4 f)
{
...
// Rounding
//////////////////////////////////////////////////////////////////////////
inline __device__ __host__ uint3 ceil(float3 f)
{
	return make_uint3( (uint)ceilf(f.x), (uint)ceilf(f.y), (uint)ceilf(f.z) );
}

//////////////////////////////////////////////////////////////////////////
// Product of all Elements of a vector
//////////////////////////////////////////////////////////////////////////
inline __device__ __host__ uint prod(uint3 v)
{
	return v.x * v.y * v.z;
}
inline __device__ __host__ float prod(float3 f)
{
	return f.x * f.y * f.z;
}